...
async function syncExpenses() {
  console.log('--- STARTING EXPENSE SYNC: LocationExpenseSheet -> ExpenseRecord ---');
  ...
  for (const sheet of sheets) {
    ...
    console.log(`\nProcessing center: ${locName} (ID: ${locId})`);
    ...
    console.log(`Synced ${centerCount} rows for ${locName}`);
  }

  console.log(`\n=== SYNC COMPLETE: Total ${totalSynced} expense entries populated successfully ===`);
}
