...
import { CENTRES } from "./centres-data";
...
export default function VirtualOfficeClient() {
  ...
  const [duration] = useState<string>("1 Year (Annual)");
  ...
  const handleSubmitBooking = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Virtual Office booked successfully! Welcome to SSPACIA.");
    } catch (err: any) {
      console.error(err);
  ...
  return (
    <div className="min-h-screen bg-[#FBFDFB] text-[#191C1C] font-sans antialiased selection:bg-teal-100 selection:text-teal-900">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl space-y-4">
            ...
            <h1 className="text-2xl sm:text-4xl font-black font-display tracking-tight text-white leading-tight">
              Prestigious Business Address in Ahmedabad
            </h1>

            <p className="text-xs sm:text-sm text-teal-100/90 leading-relaxed">
              Prime commercial mailing address and professional corporate presence across our 3 Ahmedabad centres. Fixed at <strong>₹24,000 / year</strong> for address usage with front-desk courier &amp; mail handling.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-2.5 pt-2">
              ...
              >
                <span>Select a Centre to Book</span>
            ...
            <div className="pt-4 grid grid-cols-2 sm:grid-cols-4 gap-2.5 border-t border-teal-500/30 text-[11px] text-teal-200">
              <div className="flex items-center gap-1.5">
                ...
                <span>Fixed ₹24,000 / Year</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                <span>3 Prime Centres</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
              ...
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                <span>Meeting Rooms On-Demand</span>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="bg-gray-50/90 rounded-xl p-2.5 border border-gray-200/70 space-y-1.5">
                    ...
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 pt-1.5 border-t border-gray-200/60 text-[10px] text-gray-600">
                      <span className="flex items-center gap-1">
                        <Check className="w-3 h-3 text-emerald-600" /> Prestigious Commercial Address
                      </span>
                      <span className="flex items-center gap-1">
                        <Check className="w-3 h-3 text-emerald-600" /> Mail & Courier Reception Desk
                      </span>
                      <span className="flex items-center gap-1">
                        <Check className="w-3 h-3 text-emerald-600" /> Meeting Rooms On-Demand
                      </span>
                    </div>
                  </div>
                </div>
      ...
      {/* ── 4. BOOKING MODAL (COMPACT & PROPORTIONATE) ── */}
      <AnimatePresence>
        {isBookingOpen && (
            ...
            >
              ...
              {bookingConfirmation ? (
                ...
                <div className="p-5 sm:p-6 space-y-4 text-center">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-base font-bold text-gray-900">
                      Virtual Office Booked Successfully!
                    </h4>
                    <p className="text-xs text-gray-600">
                      Your annual Virtual Office membership has been created. You can manage it immediately in your Client Dashboard.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-left space-y-2 text-xs">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-500">GST (Address Usage)</span>
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-gray-200 text-sm">
                      ...
                      <span className="font-black text-[#004D40]">₹24,000</span>
                    </div>
                  </div>

                  <p className="text-[11px] text-gray-500">
                    Confirmation details have also been sent to <strong>{contactEmail}</strong> and your contact phone <strong>{contactPhone}</strong>.
                  </p>

                  <div className="flex items-center gap-2 pt-1">
                    <Link
                      href="/dashboard"
                      className="flex-1 py-2.5 bg-[#004D40] hover:bg-[#00382E] text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-colors flex items-center justify-center gap-1.5"
                    >
                    ...
                    <button
                      onClick={handleCloseBooking}
                      className="py-2.5 px-4 bg-gray-100 text-gray-700 font-bold text-xs uppercase tracking-wider rounded-lg hover:bg-gray-200 transition-colors cursor-pointer"
                    >
                      Close
                    </button>
                  </div>
                ...
                <form onSubmit={handleSubmitBooking} className="p-5 space-y-4 max-h-[80vh] overflow-y-auto">
                  ...
                  {/* 2. Fixed Plan & Pricing Breakdown */}
                  <div className="bg-gradient-to-br from-emerald-50/70 to-teal-50/40 border border-emerald-200/80 rounded-xl p-3 text-xs space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-bold uppercase tracking-wider text-emerald-900">Plan &amp; Billing Tenure</span>
                      <span className="px-2 py-0.5 bg-emerald-600 text-white rounded font-bold text-[10px] tracking-wide uppercase">
                        Fixed Yearly Plan
                      </span>
                    </div>
                    <div className="space-y-1.5 pt-1 text-gray-700 text-xs">
                      <div className="flex justify-between">
                        <span>Commercial Address Usage:</span>
                        <span className="font-semibold text-gray-900">₹24,000 / year</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Applicable GST:</span>
                        <span className="font-semibold text-emerald-700">₹0 (0% GST for Address Usage)</span>
                      </div>
                      <div className="flex justify-between pt-1 border-t border-emerald-200 font-bold text-[#004D40]">
                        <span>Total Due:</span>
                        <span>₹24,000 / year</span>
                      </div>
                    </div>
                    <p className="text-[10px] text-gray-500 leading-tight">
                      * Strictly for commercial address usage and mail/courier reception. Not for GST registration or ROC incorporation filings.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2.5 pt-2 border-t border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        >
                          <option value="MAILING_ONLY">Business Address & Mailing Presence</option>
                          <option value="COMMERCIAL_PRESENCE">Commercial Communication Address</option>
                        </select>
                      </div>
      ...
      <AuthModal
        ...
        message="Please sign in or create an account to book your Virtual Office and manage your address membership in your client dashboard."
      />
